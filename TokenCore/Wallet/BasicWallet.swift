...
extension BasicWallet {
    ...
    public func privateKeys(password: String) throws -> [KeyPair] {
        guard keystore.verify(password: password) else {
            throw PasswordError.incorrect
        }
    ...
    public func serializeToMap() -> JSONObject {
        return keystore.serializeToMap()
    }
    
    public func calcExternalAddress(at externalIdx: Int) throws -> String {
